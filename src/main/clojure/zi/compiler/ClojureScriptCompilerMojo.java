 ...
 */
public class ClojureScriptCompilerMojo
  extends CompilerMojo
{
   ...
   *
   * @parameter expression="${maven.compiler.compilerId}" default-value="clojurescript"
   */
  ...
  protected void addClojureScriptCompileSourceRoots()
  {
